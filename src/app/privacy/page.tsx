            ...
            <section>
                ...
                <div className="mt-5 space-y-6">
                    ...
                    <div>
                        ...
                        <p className="mt-2">NecrotixLab measures visits, current public pages, traffic trends, countries, coarse cities and broad device classes to understand how the site is used and to diagnose content/navigation performance. Hosting/CDN country and city headers are preferred. When a public client IP can be read from trusted forwarding headers, the server may send it to <strong>ipwho.is</strong> to resolve country, coarse city and network-provider context such as ASN, ISP, organisation and network domain. Latitude, longitude and other precise coordinates are not stored. Recent IP/network context is available to authorised administrators for up to about 24 hours and is then cleared while non-IP page activity may remain for up to about 30 days. The public page-view tracker ignores tracking when the browser sends the Do Not Track signal. The legal basis relied on for this limited measurement is the legitimate interest in maintaining, securing and improving the site with bounded retention and data minimisation (Article 6(1)(f)).</p>
                    </div>
                    <div>
                        <h3>AI assistant</h3>
