                    ...
                    <div className="grid min-w-0 lg:grid-cols-[minmax(0,1fr)_230px]">
                        <div className="relative aspect-[5/4] min-h-0 min-w-0 overflow-hidden border-b border-white/10 sm:aspect-[4/3] lg:border-b-0 lg:border-r">
                            <svg viewBox="0 0 620 460" preserveAspectRatio="xMidYMid meet" className="block h-full w-full max-w-full" role="img" aria-label="Animated CNC toolpath around a mechanical plate">
                                ...
                                <motion.circle cx="78" cy="138" r="16" fill="none" stroke="rgba(251,191,36,.35)" initial={{ cx: 78, cy: 138, r: 16 }} animate={animatePath ? { cx: [78, 122, 446, 504, 504, 456, 150, 96, 96, 122], cy: [138, 112, 112, 170, 324, 370, 370, 316, 166, 112] } : { cx: 446, cy: 112 }} transition={animatePath ? { duration: 8, ease: 'linear', repeat: Infinity, times: [0, .07, .31, .4, .58, .66, .84, .91, .97, 1] } : { duration: 0 }} />
                                <motion.circle cx="78" cy="138" r="7" fill="#fbbf24" initial={{ cx: 78, cy: 138, r: 7 }} animate={animatePath ? { cx: [78, 122, 446, 504, 504, 456, 150, 96, 96, 122], cy: [138, 112, 112, 170, 324, 370, 370, 316, 166, 112] } : { cx: 446, cy: 112 }} transition={animatePath ? { duration: 8, ease: 'linear', repeat: Infinity, times: [0, .07, .31, .4, .58, .66, .84, .91, .97, 1] } : { duration: 0 }} />
