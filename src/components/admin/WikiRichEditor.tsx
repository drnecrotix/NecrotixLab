...
const tool = 'inline-flex size-8 items-center justify-center rounded-md border border-foreground/10 text-muted-foreground transition hover:bg-foreground/[0.04] hover:text-foreground disabled:opacity-30';
