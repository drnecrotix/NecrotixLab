...
function sourceLabel(source: ApiIntegrationField['source']) {
    if (source === 'cms') return 'API & Tokens CMS';
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-border/70 bg-muted/20 p-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-muted-foreground">Priority: API &amp; Tokens CMS → AI Assistant CMS where applicable → environment variables. GitHub can also infer the profile from Site Settings.</div>
                    </div>
                </div>
