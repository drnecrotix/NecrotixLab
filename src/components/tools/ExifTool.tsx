...
const editorFields: { key: keyof EditableExif; label: string }[] = [
    { key: 'description', label: 'Description' }, { key: 'documentName', label: 'Document name' },
    { key: 'artist', label: 'Artist' }, { key: 'copyright', label: 'Copyright' },
    { key: 'make', label: 'Camera make' }, { key: 'model', label: 'Camera model' }, { key: 'software', label: 'Software' },
    { key: 'cameraOwner', label: 'Camera owner' }, { key: 'bodySerial', label: 'Camera serial number' },
    { key: 'lensMake', label: 'Lens make' }, { key: 'lensModel', label: 'Lens model' }, { key: 'lensSerial', label: 'Lens serial number' },
    { key: 'dateTime', label: 'Modified (EXIF)' }, { key: 'dateTimeOriginal', label: 'Captured (EXIF)' }, { key: 'dateTimeDigitized', label: 'Digitized (EXIF)' },
    { key: 'latitude', label: 'GPS latitude (decimal)' }, { key: 'longitude', label: 'GPS longitude (decimal)' }, { key: 'altitude', label: 'GPS altitude (metres)' },
];
